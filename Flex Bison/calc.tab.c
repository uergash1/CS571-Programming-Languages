...
#line 33 "calc.y" /* yacc.c:359  */

	struct symbol s[10000];	

#line 177 "calc.tab.c" /* yacc.c:359  */
...
{
       0,    46,    46,    50,    51,    55,    59,    63,    67,    71,
      75,    82,    90,    91,    96,   100,   104,   108
};
#endif
...
{
  "$end", "error", "$undefined", "TOK_NUM", "TOK_PRINT", "TOK_EQUAL",
  "TOK_MUL", "TOK_SUB", "TOK_OPAR", "TOK_CPAR", "TOK_OBRAC", "TOK_CBRAC",
  "TOK_SEMICOL", "TOK_FLOAT", "TOK_ID", "TOK_MAIN", "$accept", "Prog",
  "Stmts", "Stmt", "opar", "cpar", "E", YY_NULLPTR
};
#endif
...
{
     -12,     0,    13,     9,   -16,    14,     1,     7,    15,    11,
      21,    18,    16,     1,   -16,   -16,   -16,    -3,   -16,     1,
      20,   -16,    27,    -3,   -16,    -5,   -16,   -16,   -16,   -16,
      12,    -3,    -3,   -16,   -16,    25
};
...
{
      21,    31,    32,     1,    22,     7,    20,    23,    30,     8,
       3,    24,    26,     4,     9,    10,    34,    35,    31,    32,
       5,    14,     6,    33,    15,    16,    17,    18,    19,    27,
      29,    31
};

static const yytype_uint8 yycheck[] =
{
       3,     6,     7,    15,     7,     4,    13,    10,    23,     8,
      10,    14,    19,     0,    13,    14,    31,    32,     6,     7,
      11,    14,     8,    11,     9,    14,     5,     9,    12,     9,
       3,     6
};
...
{
       0,    15,    17,    10,     0,    11,     8,     4,     8,    13,
      14,    18,    19,    20,    14,     9,    14,     5,     9,    12,
      18,     3,     7,    10,    14,    22,    18,     9,    21,     3,
      22,     6,     7,    11,    22,    22
};
...
#line 56 "calc.y" /* yacc.c:1646  */
    {
		place(position, (yyvsp[0].id).name, (yyvsp[0].id).value);
	}
...
#line 60 "calc.y" /* yacc.c:1646  */
    {
		update((yyvsp[-2].id).name, (yyvsp[0].float_val));		
	}
...
#line 92 "calc.y" /* yacc.c:1646  */
    {
		int index = search((yyvsp[0].id).name);
		(yyval.float_val) = s[index].value;
	}
